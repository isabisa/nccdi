...
if (is_page('2015-16-annual-report')) {
  $printLink = "href=\"http://ncinitiative.org/wp-content/uploads/2017/01/NC-Initiative-Annual-Report-Updated_Final.pdf\" target=\"blank\"";
} else {
...
<div class="social-share-buttons print-no">
  ...
  <a rel="nofollow" class="other-share icon-fax hidden-xs hidden-sm" <?php echo $printLink; ?>>
    Print this page
  </a>
</div>
