...
if (!defined('COOL_TIMELINE_CURRENT_VERSION')){
    define('COOL_TIMELINE_CURRENT_VERSION', '1.9');
}
    ...
    class CoolTimeline {
       ...
       public function ctl_include_files(){
            // register cool-timeline post type
              require COOL_TIMELINE_PLUGIN_DIR . 'admin/cool-timeline-posttype.php';
              ...
              */
              if(is_admin()){
              require_once COOL_TIMELINE_PLUGIN_DIR . 'admin/feedback/admin-feedback-form.php';
              ...
              */
              ...
              require COOL_TIMELINE_PLUGIN_DIR .'/admin/cool-tm-feedback-notice.php';
