...
<div class="buton_layout_container">
	...
	<label for="simple_button">
		...
		<a target="_blank" href="<?php echo esc_url('http://webdzier.com/demo/plugins/wd-button-pro/'); ?>"><?php echo __( 'Demo','button' ) ?></a>
	</label>
	...
	<label for="2d_transitions">
		...
		<a target="_blank" href="<?php echo esc_url('http://webdzier.com/demo/plugins/wd-button-pro/2d-transitions/'); ?>"><?php echo __( 'Demo','button' ) ?></a>
	</label>
	...
	<label for="border_transitions">
		...
		<a target="_blank" href="<?php echo esc_url('http://webdzier.com/demo/plugins/wd-button-pro/border-transitions/'); ?>"><?php echo __( 'Demo','button' ) ?></a>
	</label>
	...
	<label for="curl">
		...
		<a target="_blank" href="<?php echo esc_url('http://webdzier.com/demo/plugins/wd-button-pro/curl/'); ?>"><?php echo __( 'Demo','button' ) ?></a>
	</label>
	...
	<label for="speech_bubbles">
		...
		<a target="_blank" href="<?php echo esc_url('http://webdzier.com/demo/plugins/wd-button-pro/speech-bubble/'); ?>"><?php echo __( 'Demo','button' ) ?></a>
	</label>
	...
	<label for="background_transitions">
		...
		<a target="_blank" href="<?php echo esc_url('http://webdzier.com/demo/plugins/wd-button-pro/bg-transition/'); ?>"><?php echo __( 'Demo','button' ) ?></a>
	</label>
	...
	<label for="icons">
		...
		<a target="_blank" href="<?php echo esc_url('http://webdzier.com/demo/plugins/wd-button-pro/icon-button/'); ?>"><?php echo __( 'Demo','button' ) ?></a>
	</label>	
	...
	<label for="icon_with_text">
		...
		<a target="_blank" href="<?php echo esc_url('http://webdzier.com/demo/plugins/wd-button-pro/icon-with-text/'); ?>"><?php echo __( 'Demo','button' ) ?></a>
	</label>	
	...
	<label for="hexagons">
		...
		<a target="_blank" href="<?php echo esc_url('http://webdzier.com/demo/plugins/wd-button-pro/hexagon/'); ?>"><?php echo __( 'Demo','button' ) ?></a>
	</label>

	<label for="dropdown">
		<div class="wdbutton_ribbon"><a target="_blank" href="<?php echo esc_url('http://webdzier.com/'); ?>"><span><?php echo __( 'Available in Pro','button' ) ?></span></a></div>
		<img src="<?php echo esc_url( WDButton_URL.'/images/layouts/drop-down.png');?>">
		<h2 align="center" class="h2"><?php echo __( 'Drop-down','button' ) ?></h2>
		<a target="_blank" href="<?php echo esc_url('http://webdzier.com/demo/plugins/wd-button-pro/drop-down/'); ?>"><?php echo __( 'Demo','button' ) ?></a>
	</label>
...
<div class="buton_layout_container buton_sets_container">
	...
	<label for="social_button_set_with_icon">
		...
		<a target="_blank" href="<?php echo esc_url('http://webdzier.com/demo/plugins/wd-button-pro/social-button-sets/'); ?>"><?php echo __( 'Demo','button' ) ?></a>
	</label>
